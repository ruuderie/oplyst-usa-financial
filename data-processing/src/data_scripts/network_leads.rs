...
pub struct Model {
    ...
    #[sea_orm(column_type = "Text")]
    pub company_facebook_url: String,
    #[sea_orm(column_type = "Text")]
    pub company_twitter_url: String,
    #[sea_orm(column_type = "Text")]
    pub company_location_name: String,
    #[sea_orm(column_type = "Text")]
    pub company_location_locality: String,
    #[sea_orm(column_type = "Text")]
    pub company_location_metro: String,
    #[sea_orm(column_type = "Text")]
    pub company_location_region: String,
    #[sea_orm(column_type = "Text")]
    pub company_location_geo: String,
    #[sea_orm(column_type = "Text")]
    pub company_location_street_address: String,
    #[sea_orm(column_type = "Text")]
    pub company_location_address_line_2: String,
    #[sea_orm(column_type = "Text")]
    pub company_location_postal_code: String,
    #[sea_orm(column_type = "Text")]
    pub company_location_country: String,
    #[sea_orm(column_type = "Text")]
    pub company_location_continent: String,
    #[sea_orm(column_type = "Text")]
